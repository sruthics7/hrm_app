(() => {
  ...
  var it = (h, c) => () => (
    c || h((c = { exports: {} }).exports, c), c.exports
  );
  var st = (h, c, g, _) => {
  ...
  var ut = (h, c, g) => (
    ...
    st(
      c || !h || !h.__esModule
        ? B(g, "default", { value: h, enumerable: !0 })
        : g,
      h
    )
  );
  var E = it((F, J) => {
    (function (h, c) {
      typeof F == "object" && typeof J < "u"
        ? (J.exports = c())
        : typeof define == "function" && define.amd
        ? define(c)
        : ((h = typeof globalThis < "u" ? globalThis : h || self).dayjs = c());
    })(F, function () {
      "use strict";
      var h = 1e3,
        c = 6e4,
        ...
        R = {
          ...
          p: function (i) {
            return (
              { M: v, y: p, w: x, d: D, D: Y, h: T, m: k, s: y, ms: _, Q: Z }[
                i
              ] ||
              String(i || "")
                .toLowerCase()
          ...
          return (
            ...
            (n.startOf = function (t, r) {
              var e = this,
                ...
                o = function (b, m) {
                  var S = a.w(
                    e.$u ? Date.UTC(e.$y, m, b) : new Date(e.$y, m, b),
                    e
                  );
                ...
                f = function (b, m) {
                  return a.w(
                    e
                      ...
                      [b].apply(
                        e.toDate("s"),
                        (s ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(m)
                      ),
                    e
                  );
                },
            ...
            (n.$set = function (t, r) {
              ...
              if (s === v || s === p) {
                ...
                $.$d[o](f),
                  $.init(),
                  (this.$d = $.set(Y, Math.min(this.$D, $.daysInMonth())).$d);
              } else o && this.$d[o](f);
